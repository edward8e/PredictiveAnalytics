...
const Header = ({fixed}) => {
    ...
    return (
            <Navbar  style={{backgroundColor:"white",borderBottom: "1px solid #CCC"}} light expand="md" fixed={fixed} >
                <NavbarBrand tag={Link} to="/">Restaurant Analytics <Badge style={{fontSize:"0.6rem", verticalAlign:"text-top" }} className="mr-1" color="danger" pill>By Edward Hernandez</Badge></NavbarBrand>
